//We will create a React Context in this file that will house all authentication info (currentUser, Login, Log out). React
// contexts allow us to store information and transport that info to the components that use it. We could store this infor
...
// aps. Instead, we create the context and a component that will communicate this context to its children. Think of this
...
//Below are firebase functions we need to use in our Logic in the component portion of the code
...
export default function AuthProvider({children}) {
    ...
    return (
        <AuthContext.Provider value={value}>
            {/* Below, we are waiting for the AuthContext info to populate before laoding the child components in the UI */}
            {!loading && children}
