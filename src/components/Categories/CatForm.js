...
export default function CatForm(props) {
    const handleSubmit = (values) => {
        ...
        if(!props.category){
            ...
            axios.post(`https://localhost:7115/api/Categories`, catToCreate).then(() => {
                props.setShowCreate(false)//this will close the form. We passed the callback function from Categories
        ...
        //Below is the Edit logic of handleSubmit()
            ...
            axios.put(`https://localhost:7115/api/Categories/${props.category.categoryId}`, catToEdit).then(() => {
